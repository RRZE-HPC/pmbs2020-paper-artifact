...
void init4(double *a, double *b, double *c, double *d, int N)
{
	int64_t i = 0;
	...
	do
	{
		...
		#GHOST_UNROLL#svst1(pg, &(c[i+@*svcntd()]), const_vec);#UNROLL_FACTOR
		#GHOST_UNROLL#svst1(pg, &(d[i+@*svcntd()]), const_vec);#UNROLL_FACTOR
