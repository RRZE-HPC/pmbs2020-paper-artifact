...
int main(int argc, char *argv[])
{
	...
	printf("#%13s, %14s, %14s, %14s, %14s, %14s, %14s, %14s\n", "n_i", "n_j", "Size(kB)", "tot. time", "time/LUP(ms)", "cy/LUP", "cy/CL", "rep");
//	int N = 1e8;
	for(int N_not_pad=N_start; N_not_pad<N_end; N_not_pad=N_not_pad*1.1)
	{
		...
		printf("%14d, %14d, %14.2f, %14.10f, %14.10f, %14.6f, %14.6f, %14d\n", n_i, n_j, numArrays*N*sizeof(double)/(1000.0), time, time*1e6/((double)N*rep), time*freq/((double)lup*rep), time*freq*8.0/((double)lup*rep), rep);
