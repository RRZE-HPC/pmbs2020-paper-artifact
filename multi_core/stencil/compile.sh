...
# g++
INCLUDE_FLAGS="-DALIGNED -O3 -msve-vector-bits=512 -march=armv8.2-a+sve -fopenmp -Iincludes ${LIKWID_FLAG} -Wl,-T/opt/FJSVxos/mmm/util/bss-2mb.lds -L/opt/FJSVxos/mmm/lib64 -lmpg"
# FCC
#INCLUDE_FLAGS="-DALIGNED -O3 -Ksimd_reg_size=512 -march=armv8.2-a+sve -fopenmp -Iincludes ${LIKWID_FLAG}"
